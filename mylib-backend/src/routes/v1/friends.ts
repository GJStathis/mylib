...
import { getFriendSearch, getFriends, addFriend, removeFriend } from "../../controllers/db/friend_queries.js"
...
router.get("/", checkIfAuthenticated, (req: Request, res) => {
...
router.post("/", checkIfAuthenticated, (req: Request, res) => {
...
router.delete("/", checkIfAuthenticated, (req, res) => {
    const body: FriendRecord = req.body.data
